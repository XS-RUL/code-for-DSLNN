...
class Trainer:
    def __init__(self, model, model_optimizer, print_every, epochs=200, device='cpu', prefix='FD004'):
    ...
    def test(self, test_loader):
        ...
        for batch_index, data in enumerate(test_loader, 0):
            with torch.no_grad():
                ...
                '''
                score += self.score(labels * 125, predictions * 125)
                loss += criterion(labels * 125, predictions * 125) * len(labels)
